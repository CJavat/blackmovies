...
const Footer = () => {
  return (
    <div className="bg-gray-200 dark:bg-gray-900 h-24 w-full flex justify-around items-center px-5 gap-2">
      <p className="">
        CopyRight 2023
      ...
      <div className="">
        ...
        <div className="text-black dark:text-white text-3xl flex justify-between items-center">
          <a
